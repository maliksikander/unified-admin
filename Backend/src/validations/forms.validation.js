    ...
    body: Joi.object().keys({
        ...
        attributes: Joi.array().unique((a, b) => a.label === b.label && a.key === b.key).items(
            Joi.object({
                ...
                key: Joi.string(),
                valueType: Joi.string().valid("IP", "Number", "Password", "PositiveNumber", "String2000", "String50", "String100", "URL", "AlphaNum100", "AlphanumSpecialChars200", "Boolean", "Email", "StringList"),
