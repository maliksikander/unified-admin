    ...
    this.endPointService.createLocaleSetting(data).subscribe(
      (res: any) => {
        ...
        if (res.status == 200) {
          ...
          this.editData = res.localeSetting;
        }
      },
      (error: any) => {
        this.spinner = false;
